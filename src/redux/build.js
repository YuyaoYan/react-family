...
__WEBPACK_IMPORTED_MODULE_1__store__["a" /* default */].subscribe(() => console.log(__WEBPACK_IMPORTED_MODULE_1__store__["a" /* default */].getState()))()
// unsubscribe();
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__reducer_counter__ = __webpack_require__(10);
...
function combineReducers(state = {}, action) {
  ...
  // });
  return {
    counter: Object(__WEBPACK_IMPORTED_MODULE_0__reducer_counter__["a" /* default */])(state.counter, action),
  };
}
